...
public class Configs {
    ...
    private static String sellerId = ""; // 和pid一致
	...
	public static void setSellerId(String sellerId) {
		Configs.sellerId = sellerId;
	}
	

	private static boolean payAvailable = true;
	
	/**
	 * 判断当前支付宝支付是否可用下单等
	 * @return
	 */
	public static boolean isPayAvailable() {
		return payAvailable;
	}
	
	public static void setPayAvailable(boolean available) {
